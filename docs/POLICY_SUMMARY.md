...
| Зөвшөөрөл | Terms/Privacy version, locale, accepted_at, IP, user-agent | Compliance evidence |
...
├── Апп дээр encrypted (SecureStore, legacy token автоматаар migrate)
...
| Refresh токен | 30 хоног                        |
| Consent evidence | Бүртгэлийн хугацаанд + audit retention бодлогоор |
| Лог файл      | 90 хоног                        |
...
| Hosting   | Fly.io / Azure| Серверүүд        |
